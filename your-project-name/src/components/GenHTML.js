      ...
      <div>
        <div className='input-card'>
          ...
          <InputGroup className='mb-2'>
            ...
            />
            <InputGroup.Append>
              <Button onClick={this.getSaveFolder} variant='outline-secondary'><img alt='' width='20px' height='20px'
                                                                                    src={icon} /></Button>
            </InputGroup.Append>
          </InputGroup>
        ...
        <div className={'loader ' + this.state.generating}><Spinner animation='border' variant='light' /> Generating...
        </div>
      </div>
    );
  }
